...
class UiForm:
    ...
    def retranslateUi(self, Form):
        ...
        color_list = config.ENV.PLOT_CAMERA_COLORS
        self.groupBox_l1.setStyleSheet(
            'QGroupBox:title {color: ' + f'rgb{str(color_list[0])}' + ';}'
        )
        self.groupBox_r1.setStyleSheet(
            'QGroupBox:title {color: ' + f'rgb{str(color_list[1])}' + ';}'
        )
        self.groupBox_l2.setStyleSheet(
            'QGroupBox:title {color: ' + f'rgb{str(color_list[2])}' + ';}'
        )
        self.groupBox_r2.setStyleSheet(
            'QGroupBox:title {color: ' + f'rgb{str(color_list[3])}' + ';}'
        )
